...
class PzLogTest(unittest.TestCase):
    def test_create_log_directory(self):
        log = PzLog()
        log_path = "C:/Users/{}/AppData/Local/Temp/puzzle/log/unknown.log".format(os.environ["USERNAME"])
        config_path = "C:/Users/{}/AppData/Local/Temp/puzzle/log/config/unknown.conf".format(os.environ["USERNAME"])
        ...
        log_path = "C:/Users/{}/AppData/Local/Temp/puzzle/log/log_test.log".format(os.environ["USERNAME"])
        config_path = "C:/Users/{}/AppData/Local/Temp/puzzle/log/config/log_test.conf".format(os.environ["USERNAME"])
